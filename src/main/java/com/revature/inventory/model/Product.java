...
public class Product {
	...
	public Product(Long id, Long categoryId, Long manufacturerId, String name, String description, String model,
	...
	public String toString() {
		return "Product [id=" + id + ", categoryId=" + categoryId + ", manufacturerId=" + manufacturerId + ", name="
